...
activities = {
    ...
    "Basketball Team": {
        "description": "Train shooting, defense, and game strategy in competitive play",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": []
    },
    "Drama Club": {
        "description": "Act, direct, and perform in school plays and dramatic productions",
...
def unregister_for_activity(activity_name: str, email: str):
    """Alias route for unregistering via the same query parameter style used for signup."""
